...
function addTodoItem () {
    ...
    if (!date) {
        ...
        dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(date.getUTCFullYear(), date.getUTCMonth(), date.getUTCDate()), 'MMMdo', 'UTC');
        console.log(dueDate);
    }
...
function changeTaskDate () {
    ...
    dateButton.addEventListener('click', () => {
        ...
        newDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"]) (newDate, 'MMM-do');
